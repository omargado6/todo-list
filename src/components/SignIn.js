                        ...
                        <div className="mt-[25px] flex justify-end">
                            <Dialog.Close >
                                <button
                                    ...
                                    className="bg-sky3 text-white hover:bg-sky5 focus:shadow-sky7 inline-flex h-[35px] items-center justify-center rounded-[4px] px-[13px]  leading-none shadow-3xl focus:shadow-[0_0_0_2px] focus:outline-none">
                                    Submit
                                </button>
                            </Dialog.Close>
                        </div>
