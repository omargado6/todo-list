                ...
                {Todolists.map((ele) => (
                    <li id={ele.id} className="py-4 px-1 flex gap-1 w-full   shadow-3xl rounded-lg hover:-translate-y-1 duration-300">
                        ...
                        <div className="grid grid-cols-3 w-max gap-2 m-auto pr-1">
                            <button className="text-green8 hover:text-green11 hover:scale-110 duration-200">
                            ...
                            <button className="text-blackA8 hover:text-blackA11 hover:scale-110 duration-200">
